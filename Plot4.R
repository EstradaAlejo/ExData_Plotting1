...
## Make the plot
par(mfrow = c(2, 2))
with(Data, plot(full_time, Global_active_power, type="l",ylab="Global active power",xlab=NA))
with(Data, plot(full_time, Voltage, type="l",ylab="Voltage",xlab="datatime"))
...
with(Data, plot(full_time, Global_reactive_power, type="l",ylab="Global_reactive_power",xlab="datatime"))
